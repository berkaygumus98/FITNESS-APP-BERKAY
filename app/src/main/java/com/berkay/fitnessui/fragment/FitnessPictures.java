package com.berkay.fitnessui.fragment;
...
import com.berkay.fitnessui.FitnessMove;
import com.berkay.fitnessui.PopupActivity;
import com.berkay.fitnessui.R;
import com.berkay.fitnessui.recyclerview.FitnessPictureAdapter;
    ...
    private ArrayList<FitnessMove> getFitnessMoves(ArrayList<FitnessMove> fitnessMoves) {
        ...
        for (int i = 0; i<16; i++) {
            ...
            fitnessMoves.add(new FitnessMove("Fitness Move Name" + i,
                    "http://www.berkay.com/wp-content/uploads/2018/06/fitness"+i+".jpg",
